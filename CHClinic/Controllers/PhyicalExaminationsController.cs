...
namespace CHClinic.Controllers
{
    public class PhyicalExaminationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersonId,Anemia,Apperance,BP,Built,Clubbing,Cynosis,Decubities,Facies,Jaundance,LymphNode,Neck,Nutri,Oedema,Pigmentation,Pluse,ReportDetails,Respiration,Temp")] PhyicalExamination phyicalExamination, string returnUrl)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonId,Anemia,Apperance,BP,Built,Clubbing,Cynosis,Decubities,Facies,Jaundance,LymphNode,Neck,Nutri,Oedema,Pigmentation,Pluse,ReportDetails,Respiration,Temp")] PhyicalExamination phyicalExamination, string returnUrl)
        {
            if (ModelState.IsValid)
            {
